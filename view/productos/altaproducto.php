    ...
    <h2>Datos producto</h2><hr> 
		<form enctype="multipart/form-data" class="form-horizontal" id="formproducto" action="index.php?controller=producto&amp;action=altaProducto" method="POST">
			<fieldset>
				<div class="span6">
				  ...
				  <div class="control-group">
						...
						<div class="controls docs-input-sizes">
              <select  name="producto_modalidad">
                ...
                <option value="Otros">Otros</option>
				  ...
				  <div class="control-group">
						...
						<div class="controls docs-input-sizes">
						  <textarea rows="4" cols="50" name="producto_descripcion"></textarea>
            </div>
				  </div>
			  ...
			  <div class="span6">
				  <div class="control-group">
					...
					<div class="controls docs-input-sizes">
					  <input type="text" value=""  name="producto_precio">
					</div>
				  </div>
				  ...
				  <div class="control-group">
						...
						<div class="controls docs-input-sizes">
						  <input type="text" value=""  name="producto_cantidad">
						</div>
				  </div>
          ...
          <div class="control-group">
            ...
            <div class="controls docs-input-sizes">
              <input type="file" value="" name="producto_foto">
            </div>
          </div>
          <?php if (isset($errors)){?>
          ...
          <?php } ?>			 
				...
				<div class="span12">
					 <div class="span3"><button class="btn btn-primary pull-right" type="submit">Añadir producto</button></div>
        </div>
        </fieldset>
		  </form>
		  <!--Fin del formulario -->
